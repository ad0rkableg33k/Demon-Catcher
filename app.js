...
// You must replace this with your actual Application ID from the Discord Developer Portal
...
async function setupDiscordActivity() {
    ...
    if (window.parent !== window && DISCORD_CLIENT_ID !== 'YOUR_CLIENT_ID_HERE') {
        try {
            ...
            // DYNAMIC IMPORT: Prevents the entire script from crashing if Discord blocks the CDN
...
const demonSpecies = [
    ...
    { id: 4, name: "Banshee Wraith", type: "Spirit", rarity: "Uncommon", catchRate: 0.45, color: "00FFFF" },
    { id: 5, name: "Abyssal Leviathan", type: "Water", rarity: "Rare", catchRate: 0.25, color: "0033CC" },
    { id: 6, name: "Soul Harvester", type: "Undead", rarity: "Rare", catchRate: 0.2, color: "333333" },
...
navExplore.addEventListener('click', () => {
    switchView(viewExplore, navExplore);
});
